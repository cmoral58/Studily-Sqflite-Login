...
import 'package:Studily/utils/index_offset_curve.dart';
import 'package:Studily/widgets/collection_preview.dart';
...
class BooksBody extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => new _BooksBody();
}

class _BooksBody extends State<BooksBody> with SingleTickerProviderStateMixin {
