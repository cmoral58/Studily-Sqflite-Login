...
import 'package:Studily/pages/abstract/search_book_page_abstract.dart';
import 'package:Studily/pages/universal/book_notes_page.dart';
import 'package:Studily/models/Book.dart';
import 'package:Studily/pages/formal/book_details_page_formal.dart';
            ...
            return new BookCardCompact(
              ...
              onClick: () {
                Navigator.of(context).push(new FadeRoute(
                    ...
                    // name: '/book_detais_formal', isInitialRoute: false),
                    ));
              },
            );
